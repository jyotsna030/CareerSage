...
from extract.extract_simplyhired_jobs import scrape_simplyhired_jobs
...
dag= DAG(
    dag_id = "trigger_simplyhired_pipeline",
    default_args=default_args,
    description="DAG scheduled at 12 am everyday",
...
extract_jobs_task = PythonOperator(
    ...
    python_callable=scrape_simplyhired_jobs,
    dag=dag,
)
